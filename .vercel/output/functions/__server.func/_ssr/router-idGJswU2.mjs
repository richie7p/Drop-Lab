...
//#region node_modules/.nitro/vite/services/ssr/assets/router-idGJswU2.js
var router_idGJswU2_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-b-H5EHr2.css";
var APP_NAME = "Drop Lab";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "3D 物理遊樂場：掉落球體、盒子與圓柱，拖曳物體並調整重力與彈性。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-CwmW_WXa.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_idGJswU2_exports as t };
